...
{
    internal class Turtle1 : Tortoise
    {
        private string Weapon { get; set; }
        public Turtle1(string name, int age, string food, string habitat, bool skate, string weapon) : base(name, age, food, habitat, skate)
        {
            Weapon = weapon;
            Name = name;
